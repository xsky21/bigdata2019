...
sns.set_style("dark")
print(sns.distplot(red_wine,  norm_hist=False, kde=False, color="red", label="Red wine"))
print(sns.distplot(white_wine, norm_hist=False, kde=False, color="white", label="White wine"))
